...
const AppStatistics = () => {
    return (
        ...
        <section className="flex flex-col ml:flex-row pt-6 justify-center items-center w-[80%] m-auto gap-[60px]">
            ...
            <aside className="ml:w-[40%] w-[80%] text-center ml:text-left">
                <h2 className="text-[xxx-large] font-bold text-[color:var(--col-body)] leading-[50px] mb-6 mt-7 ">Stay Home, And Pray For Victims</h2>
