  ...
  return (
    ...
    <div className="w-screen bg-gradient-to-b from-[color:var(--col-home-gradient-start)] to-[color:var(--col-home-gradient-end)] px-6 pt-[3em] h-[90%]">  
      <section className="flex flex-row justify-center align-items-center p-4">
          ...
          <div className="flex flex-col ml:flex-row justify-center content-center">
            <div className="w-[50%] m-auto ml:m-0 ml:w-[25%] mb-[5em] order-0 ml:order-2">
                <img src="../assets/images/phones.png" alt="Image girl with Covid at a cellphone" className=" items-center h-auto" />
            </div>
            <div className="w-[90%] m-auto ml:w-[55%] mr-6 ml-9 flex flex-col justify-start items-center pb-[10%]">
                ...
                <div className="w-full flex justify-start ml:pl-10 ml:ml-[25%] ml-[40%] mb-8">
