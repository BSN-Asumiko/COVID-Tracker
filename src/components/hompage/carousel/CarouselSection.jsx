...
export function CarouselSection() {
    return (
        <section className="pt-[6em]">
            <div className="text-center ml:w-[35%] w-[90%]  m-auto  mb-[3.5em]">
                <p className=" text-[medium] text-[color:var(--col-body)] opacity-80">App Feature</p>
                <h2 className=" text-[xxx-large] font-bold text-[color:var(--col-body)] leading-[1.2em]">Basic Feature You Will Get When You Use</h2>
            </div>
