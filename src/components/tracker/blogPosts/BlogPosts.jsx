...
const BlogPosts = ({className}) => {
    ...
    return (
        <section className={className}>
            ...
            <ArticleItem title="What can I do to protect myself and prevent the spread of disease?" image="/assets/images/blog-3.jpg" alt="image of hands handling blood sample"  size="w-[90%]" className="flex flex-col gap-[1em] w-[100%] mb-9 justify-center justify-center" colorP="text-[color:var(--col-common-blue)]"/>
