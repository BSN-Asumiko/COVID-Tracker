...
const TotalListItem = ({text, today, cases, className, casesStyle}) => {
    return (
        <>
            <li className={`${className}  flex justify-between items-center w-[95%] m-auto p-[1.1em] mt-[1em] text-[color:var(--col-dark-blue)] text-[0.9em] font-semibold rounded-[5px] transform transition duration-450 hover:scale-105 @container/total`}>
