...
const Navbar = () => {
    ...
    return (
        <nav className="h-screen flex flex-col justify-between items-center bg-[color:var(--col-components-bg)]">
            <ul className="flex flex-col items-center w-20 leading-[1.75] border-r ">
