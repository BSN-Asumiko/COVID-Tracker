...
const CarouselCard = ({color, icon, title, text}) => {
    return (
    <section className="flex flex-col justify-start h-[13em] px-[1.5em] pb-[1.5em]  rounded-[0.4em] bg-[color:var(--col-body)] text-[color:var(--col-dark-blue)] shadow-[1em_2.8em_3.75em_-0.625em_rgba(255,255,255,0.3)]">
